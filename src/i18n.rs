...
pub struct Tr {
    ...
    pub default_formats: &'static str,
    pub custom_formats: &'static str,
    pub no_custom: &'static str,
    pub delete: &'static str,
    pub add_ext: &'static str,
...
static JA: Tr = Tr {
    ...
    default_formats: "デフォルト形式",
    custom_formats: "カスタム形式",
    no_custom: "（なし。下で追加できます）",
    delete: "削除",
    add_ext: "拡張子を追加",
    add_ext_hint: "例: csv",
    add: "追加",
...
static ES: Tr = Tr {
    ...
    no_custom: "(ninguno todavía, añada abajo)",
    delete: "Eliminar",
    add_ext: "Añadir extensión",
...
static FR: Tr = Tr {
    ...
    no_custom: "(aucun pour l'instant, ajoutez ci-dessous)",
    delete: "Supprimer",
    add_ext: "Ajouter une extension",
    add_ext_hint: "ex. csv",
    add: "Ajouter",
